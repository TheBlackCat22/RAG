...
`[](#__codelineno-89-1) "context_enrichment": { [](#__codelineno-89-2)     # Mandatory [](#__codelineno-89-3)     "dataset": "name-of-dataset", [](#__codelineno-89-4) [](#__codelineno-89-5)     # mandatory.  [](#__codelineno-89-6)     # Substitues current context variables in query and then  [](#__codelineno-89-7)     # applies filter on data [](#__codelineno-89-8)     "query_template": "projectId = '$project_id'",  [](#__codelineno-89-9) [](#__codelineno-89-10)     # Mandatory. if query matches, add these variables from the dataset  [](#__codelineno-89-11)     # into current context [](#__codelineno-89-12)     "enrich_columns": [ "bpaURL", "accedianURL" ],  [](#__codelineno-89-13) [](#__codelineno-89-14)     # Optional. If specified, and if the query does not result any rows [](#__codelineno-89-15)     # add following defaultValues into context [](#__codelineno-89-16)     "defaultValues": {}, [](#__codelineno-89-17) [](#__codelineno-89-18)     # This context enrichment would be done only the context_filter matches [](#__codelineno-89-19)     # if the context_filter is not specified, enrichment is always performed [](#__codelineno-89-20)     "context_filter": "vendorOS contains 'Juniper'" [](#__codelineno-89-21) [](#__codelineno-89-22) }`

**Enriching from a Stream**

Below is a sample configuration for **Enriching from a Stream**

`[](#__codelineno-90-1) "context_enrichment": { [](#__codelineno-90-2)     # Mandatory [](#__codelineno-90-3)     "stream": "name-of-stream",  [](#__codelineno-90-4) [](#__codelineno-90-5)     # mandatory.  [](#__codelineno-90-6)     # Substitues current context variables in query and then  [](#__codelineno-90-7)     # applies filter on stream [](#__codelineno-90-8)     "query_template": "projectId = '$project_id'",  [](#__codelineno-90-9) [](#__codelineno-90-10)     # Mandatory. if query matches, add these variables from the stream  [](#__codelineno-90-11)     # into current context [](#__codelineno-90-12)     "enrich_columns": [ "bpaURL", "accedianURL" ],  [](#__codelineno-90-13) [](#__codelineno-90-14)     # Optional. If specified, and if the query does not result any rows [](#__codelineno-90-15)     # add following defaultValues into context [](#__codelineno-90-16)     "defaultValues": {}, [](#__codelineno-90-17) [](#__codelineno-90-18)     # Optional [](#__codelineno-90-19)     # specifies sorting crtitea (in case query matches more than 1 row) [](#__codelineno-90-20)     # allows to sort specific and get the only first row [](#__codelineno-90-21)     "sorting": [ { "timestamp": "desc" } ], [](#__codelineno-90-22) [](#__codelineno-90-23)     # This context enrichment would be done only the context_filter matches [](#__codelineno-90-24)     # if the context_filter is not specified, enrichment is always performed [](#__codelineno-90-25)     "context_filter": "vendorOS contains 'Juniper'" [](#__codelineno-90-26) }`

#### ****3.15.9 Conditional Page Inclusion****

This allows App level Dashboard pages to be included only if it matches a condition based on context variables

**Conditional Dashboard Pages**

Below is a sample configuration for **Conditional Dashboard Pages**

`[](#__codelineno-91-1) "dashboard_pages": [ [](#__codelineno-91-2)   { [](#__codelineno-91-3)       "name": "juniper_device_metrics", [](#__codelineno-91-4)       "label": "Metrics", [](#__codelineno-91-5)       "icon": "license.svg", [](#__codelineno-91-6)       "context_filter": "vendorOS contains 'Juniper'" [](#__codelineno-91-7)   }, [](#__codelineno-91-8)   { [](#__codelineno-91-9)       "name": "cisco_device_metrics", [](#__codelineno-91-10)       "label": "Metrics", [](#__codelineno-91-11)       "icon": "license.svg", [](#__codelineno-91-12)       "context_filter": "vendorOS contains 'Cisco'" [](#__codelineno-91-13)   }, [](#__codelineno-91-14)   { [](#__codelineno-91-15)       "name": "generic_device_metrics", [](#__codelineno-91-16)       "label": "Metrics", [](#__codelineno-91-17)       "icon": "license.svg", [](#__codelineno-91-18)       "context_filter": "vendorOS not conatains 'Juniper' and vendorOS not conatains 'Cisco'" [](#__codelineno-91-19)   }, [](#__codelineno-91-20) ]`
...
[Example](#__tabbed_23_1)

[![](https://bot-docs.cloudfabrix.io/images/dashboards/context_substitute.png)](/images/dashboards/context_substitute.png)

Below is a sample configuration for Substituting Context Variables in Dashboard Page Attributes

[Example](#__tabbed_24_1)

`[](#__codelineno-92-1) "dashboard_pages": [ [](#__codelineno-92-2)   { [](#__codelineno-92-3)     "name": "URL_Link_1", [](#__codelineno-92-4)     "label": "End Visibility", [](#__codelineno-92-5)     "template_attrs": [ [](#__codelineno-92-6)       "launchURL" [](#__codelineno-92-7)     ], [](#__codelineno-92-8)     "icon": "insights.svg", [](#__codelineno-92-9)     "launchURL": "$url1", [](#__codelineno-92-10)     "context_filter": "url1 is not null" [](#__codelineno-92-11)   }, [](#__codelineno-92-12)   { [](#__codelineno-92-13)     "name": "URL_Link_2", [](#__codelineno-92-14)     "label": "Config Orchestration", [](#__codelineno-92-15)     "icon": "insights.svg", [](#__codelineno-92-16)     "template_attrs": [ [](#__codelineno-92-17)       "launchURL" [](#__codelineno-92-18)     ], [](#__codelineno-92-19)     "launchURL": "$url2", [](#__codelineno-92-20)     "context_filter": "url2 is not null" [](#__codelineno-92-21)   } [](#__codelineno-92-22) ]`

#### ****3.15.11 UI Display Dashboard Title****

This feature will let the user add the dashboard label as header

Enable the dashboard header area by setting the `showTitle` to **`true`** at toplevel

[![Show Title](https://bot-docs.cloudfabrix.io/images/dashboards/show_title.png)](/images/dashboards/show_title.png)
