...
|     |     |
| --- | --- |
| [1](#__codelineno-5-1)<br> [2](#__codelineno-5-2)<br> [3](#__codelineno-5-3)<br> [4](#__codelineno-5-4)<br> [5](#__codelineno-5-5)<br> [6](#__codelineno-5-6)<br> [7](#__codelineno-5-7)<br> [8](#__codelineno-5-8)<br> [9](#__codelineno-5-9)<br>[10](#__codelineno-5-10)<br>[11](#__codelineno-5-11) | `@files:loadfile            filename = 'https://bot-docs.cloudfabrix.io/data/datasets/synthetic_syslogs_dataset.csv'     --> @dm:sample            n = 0.01     --> @dm:eval            timestamp = "utcnow().isoformat()"     --> @rn:write-stream            name = "synthetic-logs-raw"` |
...
|     |     |
| --- | --- |
| [1](#__codelineno-6-1)<br> [2](#__codelineno-6-2)<br> [3](#__codelineno-6-3)<br> [4](#__codelineno-6-4)<br> [5](#__codelineno-6-5)<br> [6](#__codelineno-6-6)<br> [7](#__codelineno-6-7)<br> [8](#__codelineno-6-8)<br> [9](#__codelineno-6-9)<br>[10](#__codelineno-6-10)<br>[11](#__codelineno-6-11)<br>[12](#__codelineno-6-12)<br>[13](#__codelineno-6-13)<br>[14](#__codelineno-6-14) | `@c:timed-loop            interval = 60     --> @files:loadfile            filename = 'https://bot-docs.cloudfabrix.io/data/datasets/synthetic_syslogs_dataset.csv'     --> @dm:sample            n = 0.01     --> @dm:eval            timestamp = "utcnow().isoformat()"     --> @rn:write-stream            name = "synthetic-logs-raw"` |
...
|     |     |
| --- | --- |
| [1](#__codelineno-7-1)<br>[2](#__codelineno-7-2)<br>[3](#__codelineno-7-3)<br>[4](#__codelineno-7-4)<br>[5](#__codelineno-7-5) | `@files:loadfile            filename = 'https://bot-docs.cloudfabrix.io/data/datasets/synthetic_syslogs_dataset.csv'     --> @dm:save             name = "temp-syslogs-dataset"` |

Now let us update the whole pipeline:

|     |     |
| --- | --- |
| [1](#__codelineno-8-1)<br> [2](#__codelineno-8-2)<br> [3](#__codelineno-8-3)<br> [4](#__codelineno-8-4)<br> [5](#__codelineno-8-5)<br> [6](#__codelineno-8-6)<br> [7](#__codelineno-8-7)<br> [8](#__codelineno-8-8)<br> [9](#__codelineno-8-9)<br>[10](#__codelineno-8-10)<br>[11](#__codelineno-8-11)<br>[12](#__codelineno-8-12)<br>[13](#__codelineno-8-13)<br>[14](#__codelineno-8-14)<br>[15](#__codelineno-8-15)<br>[16](#__codelineno-8-16)<br>[17](#__codelineno-8-17)<br>[18](#__codelineno-8-18)<br>[19](#__codelineno-8-19)<br>[20](#__codelineno-8-20) | `@files:loadfile             filename = 'https://bot-docs.cloudfabrix.io/data/datasets/synthetic_syslogs_dataset.csv'     --> @dm:save             name = "temp-syslogs-dataset" --> @c:timed-loop         interval = 60     --> @dm:recall             name = "temp-syslogs-dataset"     --> @dm:sample             n = 0.01     --> @dm:eval             timestamp = "utcnow().isoformat()"     --> @rn:write-stream             name = "synthetic-logs-raw"` |
...
|     |     |
| --- | --- |
| [1](#__codelineno-9-1)<br> [2](#__codelineno-9-2)<br> [3](#__codelineno-9-3)<br> [4](#__codelineno-9-4)<br> [5](#__codelineno-9-5)<br> [6](#__codelineno-9-6)<br> [7](#__codelineno-9-7)<br> [8](#__codelineno-9-8)<br> [9](#__codelineno-9-9)<br>[10](#__codelineno-9-10)<br>[11](#__codelineno-9-11)<br>[12](#__codelineno-9-12)<br>[13](#__codelineno-9-13)<br>[14](#__codelineno-9-14)<br>[15](#__codelineno-9-15)<br>[16](#__codelineno-9-16)<br>[17](#__codelineno-9-17)<br>[18](#__codelineno-9-18)<br>[19](#__codelineno-9-19)<br>[20](#__codelineno-9-20) | `@files:loadfile             filename = 'https://bot-docs.cloudfabrix.io/data/datasets/synthetic_syslogs_dataset.csv'     --> @dm:save             name = "temp-syslogs-dataset" --> @c:timed-loop         interval = 60     --> @dm:recall             name = "temp-syslogs-dataset"     --> @dm:sample             n = 0.01     --> @dm:eval             timestamp = "utcnow().isoformat()"     --> @rn:write-stream             name = "synthetic-logs-raw"` |
...
|     |     |
| --- | --- |
| [1](#__codelineno-18-1)<br>[2](#__codelineno-18-2)<br>[3](#__codelineno-18-3)<br>[4](#__codelineno-18-4)<br>[5](#__codelineno-18-5)<br>[6](#__codelineno-18-6)<br>[7](#__codelineno-18-7)<br>[8](#__codelineno-18-8)<br>[9](#__codelineno-18-9) | `-   name: 'guide-example-produce-logs'         label: 'Produce Synthetic Syslogs'         version: '*'         site: 'cfx.*'         site_type: regex         instances: 1         scaling_policy:             min_instances: 1             max_instances: 1` |
...
|     |     |
| --- | --- |
| [1](#__codelineno-19-1)<br>[2](#__codelineno-19-2)<br>[3](#__codelineno-19-3)<br>[4](#__codelineno-19-4) | `artifact-dependency-validation:     credentials:         verify: false         exclude: demo_logarchive` |
