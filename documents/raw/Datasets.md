...
|     |     |
| --- | --- |
| [1](#__codelineno-29-1)<br>[2](#__codelineno-29-2)<br>[3](#__codelineno-29-3)<br>[4](#__codelineno-29-4) | `# See 'RDA CLI' guide for instructions to install RDA CLI Tool python3 rdac.py dataset-add \               --name 'demo_vmware_storage_inventory' \               --file 'https://bot-docs.cloudfabrix.io/data/datasets/demo_vmware_storage_inventory.csv'` |
...
|     |     |
| --- | --- |
| [1](#__codelineno-56-1)<br>[2](#__codelineno-56-2)<br>[3](#__codelineno-56-3)<br>[4](#__codelineno-56-4) | `@files:loadfile             filename = 'https://bot-docs.cloudfabrix.io/data/datasets/sample-ecommerce-data.csv'        --> @dm:save              name = 'sample-ecommerce-data'` |

|     |     |
| --- | --- |
| [1](#__codelineno-57-1)<br>[2](#__codelineno-57-2)<br>[3](#__codelineno-57-3)<br>[4](#__codelineno-57-4) | `# See 'RDA CLI' guide for instructions to install RDA CLI Tool python3 rdac.py dataset-add \               --name 'sample-ecommerce-data' \               --file 'https://bot-docs.cloudfabrix.io/data/datasets/sample-ecommerce-data.csv'` |
...
|     |     |
| --- | --- |
| [1](#__codelineno-58-1)<br>[2](#__codelineno-58-2)<br>[3](#__codelineno-58-3)<br>[4](#__codelineno-58-4) | `@files:loadfile             filename = 'https://bot-docs.cloudfabrix.io/data/datasets/sample-ecommerce-data-with-pii.csv'        --> @dm:save              name = 'sample-ecommerce-data-with-pii'` |

|     |     |
| --- | --- |
| [1](#__codelineno-59-1)<br>[2](#__codelineno-59-2)<br>[3](#__codelineno-59-3)<br>[4](#__codelineno-59-4) | `# See 'RDA CLI' guide for instructions to install RDA CLI Tool python3 rdac.py dataset-add \               --name 'sample-ecommerce-data-with-pii' \               --file 'https://bot-docs.cloudfabrix.io/data/datasets/sample-ecommerce-data-with-pii.csv'` |
...
|     |     |
| --- | --- |
| [1](#__codelineno-60-1)<br>[2](#__codelineno-60-2)<br>[3](#__codelineno-60-3)<br>[4](#__codelineno-60-4) | `@files:loadfile             filename = 'https://bot-docs.cloudfabrix.io/data/datasets/sample-prometheus-timeseries-data.csv'        --> @dm:save              name = 'sample-prometheus-timeseries-data'` |

|     |     |
| --- | --- |
| [1](#__codelineno-61-1)<br>[2](#__codelineno-61-2)<br>[3](#__codelineno-61-3)<br>[4](#__codelineno-61-4) | `# See 'RDA CLI' guide for instructions to install RDA CLI Tool python3 rdac.py dataset-add \               --name 'sample-prometheus-timeseries-data' \               --file 'https://bot-docs.cloudfabrix.io/data/datasets/sample-prometheus-timeseries-data.csv'` |
...
|     |     |
| --- | --- |
| [1](#__codelineno-62-1)<br>[2](#__codelineno-62-2)<br>[3](#__codelineno-62-3)<br>[4](#__codelineno-62-4) | `@files:loadfile             filename = 'https://bot-docs.cloudfabrix.io/data/datasets/sample-servicenow-incidents.csv'        --> @dm:save              name = 'sample-servicenow-incidents'` |

|     |     |
| --- | --- |
| [1](#__codelineno-63-1)<br>[2](#__codelineno-63-2)<br>[3](#__codelineno-63-3)<br>[4](#__codelineno-63-4) | `# See 'RDA CLI' guide for instructions to install RDA CLI Tool python3 rdac.py dataset-add \               --name 'sample-servicenow-incidents' \               --file 'https://bot-docs.cloudfabrix.io/data/datasets/sample-servicenow-incidents.csv'` |
...
|     |     |
| --- | --- |
| [1](#__codelineno-64-1)<br>[2](#__codelineno-64-2)<br>[3](#__codelineno-64-3)<br>[4](#__codelineno-64-4) | `@files:loadfile             filename = 'https://bot-docs.cloudfabrix.io/data/datasets/synthetic_syslogs_dataset.csv'        --> @dm:save              name = 'synthetic_syslogs_dataset'` |

|     |     |
| --- | --- |
| [1](#__codelineno-65-1)<br>[2](#__codelineno-65-2)<br>[3](#__codelineno-65-3)<br>[4](#__codelineno-65-4) | `# See 'RDA CLI' guide for instructions to install RDA CLI Tool python3 rdac.py dataset-add \               --name 'synthetic_syslogs_dataset' \               --file 'https://bot-docs.cloudfabrix.io/data/datasets/synthetic_syslogs_dataset.csv'` |
